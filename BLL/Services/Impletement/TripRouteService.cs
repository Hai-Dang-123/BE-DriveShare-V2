...
namespace BLL.Services.Impletement
{
    public class TripRouteService : ITripRouteService
    {
        ...
        public async Task<ResponseDTO> GenerateTripRouteAsync(Guid tripId)
        {
            ...
            {
                return new ResponseDTO("Trip does not have a ShippingRoute (plan).", 400, false);
            }
            ...
            if (trip.ShippingRoute.StartLocation.Latitude == 0 || trip.ShippingRoute.EndLocation.Latitude == 0)
            {
                return new ResponseDTO("ShippingRoute Start/End locations have not been geocoded.", 400, false);
            }
            ...
            // 3. Chuẩn bị tham số cho API Route v3
            var start = trip.ShippingRoute.StartLocation;
            var end = trip.ShippingRoute.EndLocation;
